...
function Index() {
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:9000/update/${currentPlan._id}`,
        {
          name: updateName,
  ...
  const handleDelete = async (id) => {
    try {
        ...
        const response = await axios.delete(`http://localhost:9000/deleteplane/${id}`);
        toast.success(response?.data?.message);
      ...
      <div className="w-full flex flex-col justify-center items-center px-10 ">
        <div className="w-full flex justify-end mt-5">
          <button
            ...
            className="px-5 py-3 bg-[#092C4C] rounded-md text-white font-semibold"
          >
            <p>Add Plans +</p>
          </button>
        </div>
        ...
        <div className="w-[80%]  ml-20 sm:ml-36 mt-10">
          <p className="px-14  -ml-10 text-[#092C4C] font-extrabold text-2xl">
            PLANS
          </p>
          <div className=" overflow-x-auto py-10">
            <table className="w-full min-w-[500px] text-[#092C4C]">
              <thead>
                <tr>
                  <th className="border-b border-r border-gray-300 py-2 px-4 min-w-14">
                    S.No
                  </th>
                  <th className="border-b border-r border-gray-300 px-4 min-w-32">
                    Name
                  </th>
                  <th className="border-b border-r border-gray-300 px-4 min-w-32">
                    Duration
                  </th>
                  <th className="border-b border-r border-gray-300 px-4 min-w-44">
                    Amount
                  </th>
                  <th className="border-b border-r border-gray-300 px-2 min-w-14">
                    Interest Rate
                  </th>
                  <th className="border-b border-gray-300 px-2 min-w-14">
                    Action
                  </th>
                </tr>
              </thead>
                  ...
                  <tr key={plan._id} className="text-black font-medium text-sm">
                    ...
                    <td className="py- text-center">
                      <button
                        ...
                        className="text-[8px] px-2 font-extrabold rounded-sm mr-2"
                      >
                        <CiEdit className="w-[20px] h-[50px]" />
                      </button>
                      ...
                      >
                        <MdDeleteOutline className="w-[20px] h-[50px]" />
                      </button>
        ...
        <div className="!w-full flex flex-col items-center">
          ...
          <div className="w-full flex flex-col">
            <form
              ...
              className="flex flex-col gap-2 p-2 max-h-80vh overflow-auto"
            >
              ...
              <div className="w-full flex justify-center">
                <button
                  type="submit"
                  className="max-w-80px bg-blue-600 rounded-lg font-semibold px-3 py-2 text-white"
                >
                  Submit
                </button>
              </div>
